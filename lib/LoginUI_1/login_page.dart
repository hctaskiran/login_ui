...
import 'package:login_ui/LoginUI_1/register_page.dart';
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 20),
                    RegisterForm(controller: email, hint: 'Enter an Email', label: 'Email', icon: Icons.email),
                    RegisterForm(controller: password, hint: 'Enter a Password', label: 'Password', icon: Icons.key),
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(context, FadeAnim(page: const RegisterPage()));
                    },
                    child: Text('Sign up!',
                        style: TextStyle(
