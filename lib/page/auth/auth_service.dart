...
class AuthService {
  ...
  Future<void> signUserUp(BuildContext context, TextEditingController email, TextEditingController password,
  ...
  Future<void> resetPassword(email, BuildContext context) async {
